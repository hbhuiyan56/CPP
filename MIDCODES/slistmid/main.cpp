...
#include <iostream>
#include "sortedtype.cpp" // This is correct because it's a template
#include "timeStamp.h"    // FIX 1: Changed from .cpp to .h
using namespace std;

template <class T>
void Print(SortedType<T> u){            // Helper function to Print the list

    u.ResetList(); // FIX 2: Reset the list's internal iterator
...
int main(){
    ...
    // Printing the list
    Print(timeStampList); // FIX 3: Use the corrected helper function
